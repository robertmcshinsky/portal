...
<li class="nav-item nav-dropdown">
    ...
    <ul class="nav-dropdown-items">
        ...
        <li class="nav-item"><a class="nav-link" href="{{ backpack_url('templates') }}"><i class="nav-icon la la-images"></i> Templates</a></li>
        <li class="nav-item"><a class="nav-link" href="{{ backpack_url('fields') }}"><i class="nav-icon la la-edit"></i> Fields</a></li>
    </ul>
</li>
